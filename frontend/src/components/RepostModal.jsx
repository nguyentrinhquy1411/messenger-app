...
import { X, Share, MessageSquare } from "lucide-react";
...
const RepostModal = ({ isOpen, onClose, post, onRepost }) => {
  ...
  const handleRepost = () => {
    const repost = {
      ...
      timestamp: "now",
      user: {
        name: "You", // This would come from auth context
        username: "@you",
        avatar: "/avatar.png",
        verified: false,
      },
          ...
          <div className="p-4 border-b border-base-300">
            ...
            <div className="flex justify-between items-center mt-2">
              <span className="text-sm text-base-content/50">
                {280 - repostContent.length} characters remaining
              </span>
            </div>
          </div>
        )}
          ...
          <div className="border border-base-300 rounded-lg p-4 bg-base-200/50">
            <div className="flex items-start space-x-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-base-content mt-1 text-sm line-clamp-3">
                  {post.content}
                </p>
                {post.image && (
                  <img
        ...
        <div className="p-4 border-t border-base-300">
          <div className="flex justify-end space-x-3">
            ...
            <button
              ...
              disabled={
                repostType === "quote" && repostContent.trim().length === 0
              }
